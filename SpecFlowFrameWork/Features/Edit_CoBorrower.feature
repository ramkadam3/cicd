...
| slaadmin@yopmail.com | EditedEmail@yopmail.com | Evening        | Successfully |
...
| slaadmin@yopmail.com | AppEmail@yopmail.com | Successfully |
...
Scenario Outline: To verify that Edit Financial Details form is working properly.
...
Scenario Outline: To verify that Edit Employment Details form is working properly.
Given Enter Email_PassWord for Login <User_Email>
Given Navigate to Manage Application page
Given Click on ApplicationID 
Then Check that the Borrower has a CoBorrower then Click on it Borrower details
...
| slaadmin@yopmail.com |Successfully | Unemployment         |
| slaadmin@yopmail.com |Successfully | Retired              |

Scenario:To verify that the Edit Co-Borrower flow working smoothly
Given Enter Email_PassWord for Login <User_Email>
Given Navigate to Manage Application page
Given Click on ApplicationID
...
Given Navigate to Co-Borrower section of application <CoBorrower>
