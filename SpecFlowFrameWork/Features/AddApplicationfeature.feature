...
#| slamember@yopmail.com | AppEmail@yopmail.com | Any Time       | Unable   | AES    | Education  | Paycheck   | Weekly          | Part Time Employment | Associate Degree |  Spouse      |
...
Examples:
| User_Email           | Message      | Agency | TypeOfLoan |
| slaadmin@yopmail.com | Unable       | AES    | Education  |
#|slamember@yopmail.com | Unable       | AES    | Education  |
...
@retry:2
Scenario:To verify that the Add Application flow working smoothly
Given Enter Email_PassWord for Login <User_Email>
Given Navigate to Manage Application page
When Click on Add-Application button
When Provide required details to contact details step <Email>, <BestTimeToCall>
...
When Expand Card of Borrower details Other
